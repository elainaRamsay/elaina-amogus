...
int bagWidth = 50;
int bodyHeight = 240;
int distCentreToHeadBottomY = 70;
int headWidth = 200;
int headHeight = 130;
...
void draw(){
  background(255);
  noStroke();
  arc(bodyCentreX,bodyCentreY-distCentreToHeadBottomY,headWidth,headHeight,PI,TWO_PI); // draw head top
  ...
  arc(bodyCentreX,bodyCentreY+60,20,5,0,PI); // draw crotch (legs middle)
  ...
  rect(bodyCentreX - bodyWidth/2 - bagWidth,bodyCentreY-distCentreToHeadBottomY,bagWidth,130); //back back/air thingo
  
  rect(bodyCentreX-bodyWidth/2,bodyCentreY-distCentreToHeadBottomY,90,200); 
